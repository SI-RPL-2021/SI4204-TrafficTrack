...
Route::get('/lihatfeedback',"FeedbackController@lihatfeedback")->name("lihatfeedback");
Route::get('/kelolacctv',"CctvController@index")->name("kelolacctv");
Route::get('/laporankecelakaan',"LaporanController@laporankecelakaan")->name("laporankecelakaan");
Route::get('/deletelaporan/{id}',"LaporanController@delete")->name("deletelaporan");
Route::get('/terimalaporan/{id}',"LaporanController@terima")->name("terimalaporan");
...
Route::get("/tambahcctvform","CctvController@tambahcctvform")->name("tambahcctvform");
Route::post("/tambahcctv","CctvController@tambah")->name("tambahcctv");
Route::get("/deletecctv/{id}","CctvController@delete")->name("deletecctv");
Route::get("/setpublikcctv/{id}","CctvController@setPublik")->name("publikcctv");
Route::get("/setpribadicctv/{id}","CctvController@setPribadi")->name("pribadicctv");
Route::get("/laporankecelakaanditerima","LaporanController@laporankecelakaanditerima")->name("laporankecelakaanditerima");
...
Route::get("/verifikasi","AdminController@verifikasiuser")->name('verifikasiuser');
Route::get("/verifikasi/{id}","AdminController@doverifikasiuser")->name('do-verifikasiuser');